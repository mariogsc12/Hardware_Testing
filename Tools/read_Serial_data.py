...
def saveData(name):
    ...
    data = {
        ...
        'control_action': np.array(control_action_data).reshape(-1, 1),
        'speed': np.array(speed_data).reshape(-1, 1),
        'filtered_speed': np.array(filtered_speed_data).reshape(-1, 1)
    }
